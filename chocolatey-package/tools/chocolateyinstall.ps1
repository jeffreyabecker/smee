...
$zipPackage = "$(Split-Path -Parent $MyInvocation.MyCommand.Definition)\\packed.zip"
...
$packageArgs = @{
  ...
  softwareName  = 'smee*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
